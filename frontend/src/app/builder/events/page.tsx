          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="region-na" defaultChecked />
                    <Label htmlFor="region-na">North America</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="region-eu" defaultChecked />
                    <Label htmlFor="region-eu">Europe</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="region-apac" defaultChecked />
                    <Label htmlFor="region-apac">Asia Pacific</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="region-latam" defaultChecked />
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="format-inperson" defaultChecked />
                    <Label htmlFor="format-inperson">In-Person</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="format-virtual" defaultChecked />
                    <Label htmlFor="format-virtual">Virtual</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="format-hybrid" defaultChecked />
