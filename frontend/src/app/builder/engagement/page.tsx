          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-2 space-y-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="platform-github" defaultChecked />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="platform-discourse" defaultChecked />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="platform-slack" defaultChecked />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="platform-stackoverflow" defaultChecked />
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="type-questions" defaultChecked />
                    <Label htmlFor="type-questions">Questions</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="type-discussions" defaultChecked />
                    <Label htmlFor="type-discussions">Discussions</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="type-contributions" defaultChecked />
                    <Label htmlFor="type-contributions">Contributions</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="type-mentions" defaultChecked />
