...
export const alt = 'OpenClaw: From Side Project to 145K GitHub Stars'
    ...
    (
      <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', padding: '60px 80px', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', marginBottom: '32px' }}>
          ...
          <div style={{ display: 'flex', padding: '6px 16px', borderRadius: '20px', background: 'rgba(249,115,22,0.1)', border: '1px solid rgba(249,115,22,0.2)' }}>
            <span style={{ color: '#fdba74', fontSize: '16px', fontWeight: 600 }}>DevTools</span>
          </div>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center' }}>
          <h1 style={{ color: '#f1f5f9', fontSize: '52px', fontWeight: 700, lineHeight: 1.15, margin: 0, letterSpacing: '-0.02em' }}>OpenClaw AI Agent</h1>
          <p style={{ color: '#94a3b8', fontSize: '26px', fontWeight: 400, margin: '20px 0 0 0', lineHeight: 1.4 }}>From Side Project to 145K GitHub Stars</p>
        </div>
